...
```{r samp.noise.ww.boot.plot,eval=TRUE,echo=TRUE,fig.cap='Average bootstrapped approximations of sampling noise over replications of samples of different sizes (true sampling noise in red)',fig.align='center',out.width=cst,fig.pos='htbp'}
for (k in (1:length(N.sample))){
