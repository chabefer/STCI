...
The aggregated effect estimated using the Sun and Abraham appraoch as implemented in `fixest` is equal to `r round(ATT.agg.CSA[[1]],2)` $\pm$ `r round(1.96*ATT.agg.CSA[[2]],2)`.
...
[Borusyak, Jaravel and Speiss (2021)](http://arxiv.org/abs/2108.12419) adopt a very differnet framework from the previous ones.
