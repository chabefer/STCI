...
The most basic regression-based way.
...
A much simpler approach is simply to first-difference the data and regress the obtained differenced outcome on the treatment dummy.
