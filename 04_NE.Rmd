...
```{r PlotDID,eval=TRUE,fig.cap='Evolution of average outcomes in the treated and control group',fig.align='center',out.width='.65\\textwidth',echo=FALSE,results='hide',fig.pos='htbp'}
x <- c("Before","After")
