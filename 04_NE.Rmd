...
We have $\Delta^Y_{LATE} =$ `r round(mean.y1.comp.pop-mean.y0.comp.pop,3)`.
The Wald estimator is equal to $\Delta^Y_{Wald} =$ `r round((mean.y1.comp.pop*prop.comp.pop+mean.y1.at.pop*prop.at.pop+mean.y0.nt.pop*prop.nt.pop-(mean.y0.comp.pop*prop.comp.pop+mean.y1.at.pop*prop.at.pop+mean.y0.nt.pop*prop.nt.pop))/(prop.at.pop+prop.comp.pop-prop.at.pop),3)`.
They are obviously equal.
This is because the numerator of the Wald is equal to the product of the LATE multiplied by the proportion of compliers (which is equal to `r round((mean.y1.comp.pop-mean.y0.comp.pop)*prop.comp.pop,3)`).
...
Indeed, we have that the numerator of the Wald estimator is equal to: `r round((mean.y1.comp.pop*prop.comp.pop+mean.y1.at.pop*prop.at.pop+mean.y0.nt.pop*prop.nt.pop-(mean.y0.comp.pop*prop.comp.pop+mean.y1.at.pop*prop.at.pop+mean.y0.nt.pop*prop.nt.pop)),3)`.
