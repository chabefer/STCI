...
This follows from Lemma 4.2 in [Dawid (1979)](https://www.jstor.org/stable/2984718) that shows that if $X\Ind Y|Z$ and $U$ is a function of $X$ then $U\Ind Y|Z$.
```
...
#### Identification of the Intention to Treat Effect
