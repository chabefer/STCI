...
Without conditioning on $Y_i^B$, we are thus making a very large mistake as to the true ITE.
This is probably because $y_i^B$ is not identically distributed between treatment and control, generating sampling noise.
...
There are four ways to compute the LATE:
  ...
  4. We can run a regression of $Y$ on $D$ using $R$ as an instrumental variable and controlling for some variables $X_i$.
...
**<span style="font-variant:small-caps;">Write Wald</span>**
...
**<span style="font-variant:small-caps;">Explain</span>**
...
**<span style="font-variant:small-caps;">Does conditioning on covariates improve precision?</span>**

### Estimating sampling noise

**<span style="font-variant:small-caps;">Derive CLT disrtribution </span>**
