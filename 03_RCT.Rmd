...
$D_i^{1}$ indicates whether individual $i$ takes the treatment when receving the encouragement and $D_i^{0}$ whether he takes the treatment when not receiving the encouragement.
These potential outcomes define four possible types of individuals, that I'm going to denote with the random variable $T_i$:

  - **Always takers**, that take up the program whether they receive the encouragement or not.
  They are such that $D_i^{1}=D_i^{0}=1$.
  I denote them $T_i=a$.
  - **Never takers**, that do not take up the program whether they receive the encouragement or not.
  They are such that $D_i^{1}=D_i^{0}=0$.
  I denote them $T_i=n$.
  - **Compliers**, that take up the program when they receive the encouragement and do not when they do not receive the encouragement.
  They are such that $D_i^{1}-D_i^{0}=1$.
  I denote them $T_i=c$.
  - **Defiers**, that do not take up the program when they receive the encouragement and take it up when they do not receive the encouragement.
  They are such that $D_i^{1}-D_i^{0}=-1$.
  I denote them $T_i=d$.
...
\end{align*}
```
with $Y_i^{1,1}$, $Y_i^{0,1}$, $Y_i^{0,0}$, $Y_i^{1,0}$, $D_i^1$ and $D^0_i$ the same potential outcomes and self-selection decisions as in a routine allocation of the treatment.
...
We assume that the encouragement increases participation for everyone: 

\begin{align*}
  \forall i\text{, }D_i^1\geq D_i^0.
\end{align*}
```
...
**<span style="font-variant:small-caps;">Do proof</span>**
**<span style="font-variant:small-caps;">Exclusion restriction has already been stated in the same form for eligibiity designs?</span>**
