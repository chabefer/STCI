...
but it varies accross the population. It is sometimes called a
heterogeneous or a random coefficient. In my simplified model,
...
\textbf{\textsc{Example (regress on noise)}}
