...
{\centering \includegraphics[width=0.6\linewidth]{STCI_files/figure-latex/samp.noise.ww.boot.plot-1} 

}

\caption{Average bootstrapped approximations of sampling noise over replications of samples of different sizes (true sampling noise in red)}(\#fig:samp.noise.ww.boot.plot)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{STCI_files/figure-latex/conf.interval.boot-1} 
