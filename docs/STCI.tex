...
{\centering \includegraphics[width=0.6\linewidth]{STCI_files/figure-latex/confinterval.ES-1} 

}

\caption{Confidence intervals of $\hat{ES}$ for $\delta=$ 0.99 (red) and 0.95 (blue) over sample replications for various sample sizes}(\#fig:confinterval.ES)
\end{figure}

Figure @ref(fig:confinterval.ES) presents the 99\% and 95\% confidence
