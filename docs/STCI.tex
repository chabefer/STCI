...
ones are going to reach publication, generating a pattern of over
estimation of the true treatment effect. They key trade off is whether
the resulting bias is very large or not.

\textbf{\textsc{Numerical example.}}
...
The key question os whether these QRPs only move borderline significant
