...
xtable(table.D.sharp,caption='Treatment allocation with sharp cutoff rule',label='tab:tableDsharp')
```

We can see on Table \@ref(tab:tableDsharp) that there are `r table.D.sharp[which(names(table.D.sharp)==1)]` treated observations.
