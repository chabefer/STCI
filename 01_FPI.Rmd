...
In the sample, the counterfactual is well aproximated by the outcomes of the untreated: $\hat{\esp{Y_i^0|D_i=1}}=$ `r round(mean(y0[Ds==1]),3)` $\approx$ `r round(mean(y0[Ds==0]),3)` $=\hat{\esp{Y_i^0|D_i=0}}$.
