...
Again, although the precise quantitative result is affected by the choice of $\delta$, buthte qualitative message stays the same: sampling noise is of the same order of magnitude as the estimated treatment effect. 
...
remark: maybe normalize standard deviations once and for all, as in the metric system.
