...
Figure \@ref(fig:confinterval.ES) presents the `r 100*delta`\% and `r 100*delta.2`\% confidence intervals for the effect size estimated in 40 samples selected from our simulations.
