...
Under the null of no effect and no QRPs, this would have happened with probability  `r round(dbinom(5,6,0.5),2)` and this or something worse would have happened with probability `r round(1-pbinom(5-1,6,0.5),2)`.
