...
Under the assumption that $\theta^*_k\Ind\sigma^*_k$, and that the support of $\sigma_k$ contains an open interval, $p(.)$ is identified up to scale and the distribution of $\theta$ is identified.
```

```{proof}
See Andrews and Kasy, \href{supplemtary material}{https://www.aeaweb.org/content/file?id=10286}.
```

```{remark}
There might be a mistake in the proof of Proposition 3.
