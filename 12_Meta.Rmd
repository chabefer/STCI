...
```{remark}
The approach is probably incorrect in the heterogeneous treatment effect case since we do not normalize using $\tau^2$.
...
#### Other methods: trim and fill and selection models
