...
What about if we have only the p-value and sample size?

Remark that using only positive values is a benefit, sicne the preferred direction is less likely to have been slectively underreported.

Remark that there seems to be a mistake in the numérator in the original paper.
