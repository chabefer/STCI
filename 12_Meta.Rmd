...
```{r pCurvePlot,eval=TRUE,echo=TRUE,results='hide',warning=FALSE,error=FALSE,message=FALSE,fig.cap='P-curve plot in our example', fig.align='center',out.width='50%',fig.pos='htbp',fig.height=8,fig.width=12}
...
##### Correction for QRPs and publication bias using p-curving
